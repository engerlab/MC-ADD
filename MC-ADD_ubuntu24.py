...
#       
#       - For Meshgeometries, they must be defined in their respective field with their exact names, separated by commas.
#         If a Meshgeometry is added, then make sure you uncoment such geometry and to define their materials!!
...
def save_input():
    ...
    CAD_Folder_Path = CAD_Folder_Input.get()                                                  # Stores the path to the folder containing the Meshfiles
...
# :::::: NUMBER OF RUNS ::::::
Runs_label = tk.Label(root, text="Number of events", font=("Times New Roman", 12), bg="#F5F5F5", fg="black", width=30, anchor="center", justify="center")
